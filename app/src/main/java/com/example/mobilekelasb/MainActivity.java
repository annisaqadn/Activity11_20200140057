package com.example.mobilekelasb;
...
public class MainActivity extends AppCompatActivity {
    private RecyclerView recyclerView;//mendefinisikan variable yang akan dipakai
    private FloatingActionButton btnAdd; //mendefinisikan variable yang akan dipakai
    ...
    //method untuk menampilkan data agar ditampilkan pada saat aplikasi pertama kali di running
    @Override
